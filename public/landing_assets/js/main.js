$(document).ready(function () {
    ...
    $(".active-banner-slider").owlCarousel({
        ...
        nav: true,
        navText: [
            "<img src='landing_assets/img/banner/prev.png'>",
            "<img src='landing_assets/img/banner/next.png'>",
        ],
        dots: false,
    });
    ...
    $(".active-product-area").owlCarousel({
        ...
        nav: true,
        navText: [
            "<img src='landing_assets/img/product/prev.png'>",
            "<img src='landing_assets/img/product/next.png'>",
        ],
        dots: false,
    });
